...
document = [
    ...
    "Akash kumar love build tech whihc i his fav by the way",
    "akash kumar have started a company called euron ",
    "in coursera we have courses , resume ai , job system , avni along with lots of courses projects on different different mode",
    "akash Kumar's life is a story of triumph over adversity, driven by the belief in the transformative power of education. Born in Nalanda, Bihar",
